...
Gajin Kim -
Both Jayant and I worked on all parts of the project from beginning, middle, and finish. That said, we determined that it would be more optimal for each of us to prioritize certains parts of the project given our schedules. Some of the things I primarily focused on were procuring adequate datasets, cleaning the datasets, and creating the presentation slides. We both made contributions to the project proposal and analysis.

Jayant Shah - 
Primarily focused on the analysis and drawing the conclusions. Also contributed to the project proposal and presentation. Worked together on writing the script and recording the presentation. Both group members worked on managing and comitting to the project github.
```